...
- Current active design slice: issue `#32` defines the `XRTL.Core` foundation contract. Do not add runtime Pascal implementation files for `XRTL.Core` until this design is reviewed and accepted.
