...
$databaseTests = @("database_smoke", "database_sqlite_tests", "database_transaction_tests", "database_raw_mapping_tests", "database_dataset_tests", "database_provider_tests")
