...
$databaseTests = @("database_smoke", "database_sqlite_tests", "database_transaction_tests", "database_raw_mapping_tests", "database_dataset_tests", "database_provider_tests", "database_migration_tests", "database_query_builder_tests", "database_orm_tests", "database_orm_v1_tests", "database_attachment_tests")
